 ...
 */
public class OrderExpressFragment extends BaseFragment implements IRecycleViewItemClickListener {
    public static final String TAG = OrderExpressFragment.class.getSimpleName();

    private static final String ORDER_STATE = "express";
